...
exports.NETWORK_ERROR_CATEGORY_BY_CODE = exports.API_PROVIDER_HTTP_ERROR_LINKS = exports.MAX_DIAGNOSTIC_FIELD_LENGTH = void 0;
const consts_1 = require("../consts");
exports.MAX_DIAGNOSTIC_FIELD_LENGTH = 300;
exports.API_PROVIDER_HTTP_ERROR_LINKS = {
    401: {
        deepseek: {
            labelKey: 'error.action.createApiKey',
            url: consts_1.EXTERNAL_URLS.deepseek.apiKeys,
        },
    },
    402: {
        deepseek: {
            labelKey: 'error.action.viewUsage',
            url: consts_1.EXTERNAL_URLS.deepseek.usage,
        },
    },
    '5xx': {
        deepseek: {
            labelKey: 'error.action.checkDeepSeekStatus',
            url: consts_1.EXTERNAL_URLS.deepseek.status,
        },
    },
};
/**
 ...
 */
exports.NETWORK_ERROR_CATEGORY_BY_CODE = {
    ENOTFOUND: 'dns',
    EAI_AGAIN: 'dns',
    ENODATA: 'dns',
    ESERVFAIL: 'dns',
